        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-400 mt-6 max-w-xl leading-8">
              Passionate about Artificial Intelligence, DevOps,
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              ...
              <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:scale-105 hover:shadow-cyan-500/50 hover:shadow-xl transition duration-300 px-6 py-3 rounded-xl font-semibold">

                View Projects

              </button>

              <button className="border border-cyan-400 hover:bg-cyan-500 hover:scale-105 transition duration-300 px-6 py-3 rounded-xl font-semibold">
            ...
            <div className="flex gap-6 text-3xl mt-8">
              ...
              <a href="mailto:saideepmalgireddy@gmail.com">
                <FaEnvelope className="hover:text-cyan-400 hover:scale-125 transition duration-300 cursor-pointer" />
              </a>

              <FaLinkedin className="opacity-50 hover:text-cyan-400 hover:scale-125 transition duration-300 cursor-pointer" />
          ...
          >
            ...
            <motion.img
              ...
              className="w-80 h-80 md:w-96 md:h-96 rounded-full object-cover border-4 border-cyan-400 shadow-[0_0_80px_rgba(34,211,238,0.7)]"
            />
